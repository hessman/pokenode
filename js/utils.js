...
class Utils {
    ...
    */
    ...
    static async getHash(pokemonFile) {
        /*
        Computes a unique hash for a pokemon file and write the hash into it.
        ...
        let hash = crypto.createHash('sha256').update(clear).digest('base64')
        await fs.writeFile(pokemonFile, hash)
        return hash
    }
